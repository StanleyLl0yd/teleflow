...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"TeleFlow.TeleFlowDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"TeleFlow.TeleFlowDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"TeleFlow.lnk"_q;
